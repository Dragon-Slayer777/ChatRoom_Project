...
class GUI: #so here we are using some object oriented programming to initiate a class for the graphical user interface[GUI] because if we tried to define seperate functions on differentobjects then there is lack of efficiency
